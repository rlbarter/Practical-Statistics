...
Write your blog post in RStudio as an R Markdown file (please copy the format of existing blog posts), and save your `.Rmd` file in the `/content/post` folder (which lives on the `gh_pages` branch).
